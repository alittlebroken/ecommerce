    ...
    beforeAll: async () => {
       // User Setup
        ...
        const users = [
            ...
            { email: 'littleted@ursine.com', password: 'goldih4t3r1986', forname: 'Little', surname: 'Ted'}
        ];
        ...
        const user4 = await db.query(userQuery, [users[3].email, users[3].password, users[3].forename, users[3].surname]);
